...
export const AJUDA = {
  ...
  benemerencia:
    "A Bolsa de Benemerência recolhe as doações voluntárias dos irmãos para as ações fraternas da Loja. A página traz o QR Code e o código Pix Copia e Cola da chave cadastrada — você escolhe o valor no app do seu banco. A chave Pix da Benemerência é cadastrada pelo Venerável Mestre nas Configurações da Loja; se não houver uma específica, vale a chave Pix das capitações (Tesouraria).",
  rifa:
    "A Rifa de Benemerência é uma campanha solidária habilitada pelo Venerável Mestre ou pelo Esmoler (aqui ou nas Configurações da Loja), com período de vendas, quantidade de números, valor de cada número e data do sorteio. Enquanto vigente, aparece no menu de todos os irmãos: toque nos números livres para reservar os seus e pague por Pix pelo QR Code (chave da Benemerência) — o Esmoler dá baixa no pagamento. Você pode liberar um número seu ainda não pago durante as vendas. No dia do sorteio, o VM ou o Esmoler sorteia pelo próprio sistema (entre os números pagos, podendo incluir os não pagos; a semente aleatória fica registrada para qualquer irmão conferir) ou informa o número de um sorteio externo — o sistema aponta o irmão dono do número e avisa todo o quadro.",
  admissoes:
  ...
  solicitacoes:
    "Solicitações à Secretaria reúne, num só lugar, os pedidos que qualquer irmão do quadro pode fazer: Atestado de Regularidade, Quitte Placet e Pedido de Afastamento (Form. 116). Cada pedido tem a sua página com o formulário e a linha do tempo mostrando com quem está pendente; todas as assinaturas são pelo gov.br.",
  afastamento:
    "O Pedido de Afastamento é a licença do quadro de obreiros (Form. 116 do GOB). O irmão informa o prazo em dias e o motivo; o sistema gera o requerimento em PDF e ele o assina com a PRÓPRIA conta gov.br (direto pela conta ou pelo portal assinador.iti.br). A Loja delibera em sessão; a Secretaria registra a data da sessão e o artigo do Regulamento Geral (67 ou 68) e o sistema gera o Form. 116, assinado pelo gov.br pelo Secretário e, por último, pelo Venerável Mestre. Enviado à Guarda dos Selos (Form. 116 + requerimento), o irmão passa à situação LICENCIADO. A linha do tempo mostra com quem o pedido está pendente.",
  processos:
  ...
  quitte:
    "Quitte Placet é o documento de desligamento ou transferência do irmão. Qualquer irmão ATIVO pode solicitar o seu, anexando a carta escrita a próprio punho e assinada (obrigatória). Só pode ser emitido com o Nada Consta da Tesouraria (trava financeira) e a tripla assinatura gov.br — o Secretário primeiro, o Orador em seguida e o Venerável Mestre por último. O irmão acompanha aqui com quem o pedido está pendente; a Secretaria faz a triagem (carta, Nada Consta, Form. 122 em PDF), registra em Processos a sessão em que o pedido foi comunicado à Loja com a respectiva ata, as assinaturas são colhidas na aba Processos e, aprovado, o documento é enviado à Guarda dos Selos.",
  mensalidades:
